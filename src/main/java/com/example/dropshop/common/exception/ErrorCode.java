...
public enum ErrorCode {
  ...
  PRODUCT_CORE_UPDATE_LOCKED(
      HttpStatus.BAD_REQUEST, "READY 또는 ON_SALE 상태에서는 상품명/가격/할인율을 수정할 수 없습니다."),
  INVALID_PRODUCT_STATUS_CHANGE(HttpStatus.BAD_REQUEST, "판매자 수동 상태 변경은 HIDDEN만 가능합니다."),
  PRODUCT_DELETE_NOT_ALLOWED(HttpStatus.BAD_REQUEST, "드랍 또는 주문 이력이 존재하는 상품은 삭제할 수 없습니다."),
  INVALID_IMAGE_FILE_TYPE(HttpStatus.BAD_REQUEST, "이미지 파일 타입은 jpeg, png, webp만 허용됩니다."),
  ...
  DROP_TOTAL_STOCK_EXCEEDS_PRODUCT_STOCK(HttpStatus.BAD_REQUEST, "드랍 총 판매 수량은 상품 재고를 초과할 수 없습니다."),
  DROP_ACCESS_DENIED(HttpStatus.FORBIDDEN, "본인 상품의 드랍만 관리할 수 있습니다."),
  DROP_ALREADY_EXISTS(HttpStatus.BAD_REQUEST, "해당 상품에는 진행 중이거나 예정된 드랍이 이미 존재합니다."),
  DROP_ACTIVE_UPDATE_LOCKED(HttpStatus.BAD_REQUEST, "ACTIVE 상태에서는 드랍 시작 시간과 총 판매 수량을 수정할 수 없습니다."),
  ...
  DROP_DELETE_NOT_ALLOWED(HttpStatus.BAD_REQUEST, "주문 이력이 있거나 예정 상태가 아닌 드랍은 삭제할 수 없습니다."),
  DROP_STOP_NOT_ALLOWED(HttpStatus.BAD_REQUEST, "이미 종료된 드랍은 강제 종료할 수 없습니다."),
